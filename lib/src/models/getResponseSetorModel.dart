...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    detailSetor: List<DetailSetor>.from(json["detail_setor"].map((x) => DetailSetor.fromJson(x))),
  );
...
class DetailSetor {
  ...
  factory DetailSetor.fromRawJson(String str) => DetailSetor.fromJson(json.decode(str));
