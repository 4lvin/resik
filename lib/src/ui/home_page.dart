...
import 'package:b_sampah/src/ui/detail_notif.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(statusBarColor: Colors.blueGrey));
    return new Scaffold(
          ...
          children: <Widget>[
              ...
              child: SmartRefresher(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Padding(
                      padding: EdgeInsets.only(top: MediaQuery.of(context).size.height / 3.0 - 80.0),
                      child: Column(
                        children: <Widget>[
                          ...
                          GridView.count(
                            ...
                            children: <Widget>[
                              ...
                              _buildCard('Cek Transaksi', 2, "assets/invoice.png", linkCekTrx),
                            ],
                          )
                        ],
                      ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[Text("Informasi terbaru"), Text("Lihat semua")],
              ),
            ),
            SizedBox(
              height: 8,
                  ...
                  if (snapshot.hasData) {
                    return snapshot.data.data.isNotEmpty
                        ...
                        itemBuilder: (BuildContext context, int i) {
                          var formatDate = DateFormat('d MMM yyyy').format(snapshot.data.data[i].tanggal);
                          var formatTime = DateFormat().add_jm().format(snapshot.data.data[i].tanggal);
                          return Container(
                            height: 70,
                            decoration: BoxDecoration(
                                    ...
                                    leading: Stack(
                                      children: <Widget>[
                                        ...
                                        Container(
                                            ...
                                            width: 40,
                                            height: 40,
                                            child: Hero(tag: "notif$i", child: Image.asset("assets/notif.png"))),
                                      ],
                                    ),
                                    title: Text(
                                      snapshot.data.data[i].keterangan,
...
//                              Divider(),
  ...
  void linkCekTrx() {
    Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new CekTransaksi()));
  }

  Widget _buildCard(String name, int cardIndex, String images, dynamic kategori) {
    return FadeAnimation(
      ...
      Card(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                    begin: Alignment.bottomCenter, end: Alignment.topCenter, colors: [Colors.grey[200], Colors.white]),
              ),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
          ...
          margin: cardIndex.isEven ? EdgeInsets.fromLTRB(15.0, 50.0, 30.0, 15.0) : EdgeInsets.fromLTRB(30.0, 50.0, 15.0, 15.0)),
    );
  }
}
